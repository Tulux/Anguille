...
void print_usage()
{
    ...
    printf("\n");
    printf("Example:\n");
    printf("Server: anguille -v 1 -r 4500:4600 -t 22 -p MY_PASS_123 -m 9870 -s\n");
    printf("Client: anguille -v 1 -r 6200:6300 -t 1234 -p MY_PASS_123 -m 9870 -i 178.175.135.122\n");
}
